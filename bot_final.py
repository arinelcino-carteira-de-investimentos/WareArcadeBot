"""
================================================================
🎮 WareArcadeBot - Versão Final com requests
================================================================
Bot: @warecade_bot
Versão: 4.0 - Usando requests em vez de httpx
================================================================
"""
...
# ── Força o uso de requests em vez de httpx ──
import requests
...
# ════════════════════════════════════════════════════════════════
# REQUESTS ADAPTER - Substitui o httpx pelo requests
# ════════════════════════════════════════════════════════════════

class RequestsAdapter(BaseRequest):
    """Adaptador para usar requests em vez de httpx."""
    ...
    async def do_request(self, request: RequestData) -> tuple:
        ...
        try:
            if method == 'GET':
                ...
                # Se tiver arquivos, usa multipart
                if request.files:
                    files = {}
...
CATEGORIES = [
    ...
    "Antivírus", "Ferramentas", "Streaming", "Música", 
    "Gift Card", "Cloud", "Curso",
]
...
GAMES_CATALOG = [
    ...
    {"id": 4, "nome": "Red Dead Redemption 2", "preco_original": 64.90, "preco_oferta": 38.90, "descricao": "Ação e aventura no Velho Oeste.", "categorias": ["Ação", "Aventura", "Destaques"], "oferta": True, "plataforma": "PC", "tipo": "🎮 Jogo", "imagem_url": "https://cdn.akamai.steamstatic.com/steam/apps/1174180/header.jpg"},
    {"id": 5, "nome": "Elden Ring", "preco_original": 45.90, "preco_oferta": 32.90, "descricao": "RPG de ação em mundo aberto.", "categorias": ["RPG", "Ação", "Destaques", "Mais Vendidos"], "oferta": True, "plataforma": "PC", "tipo": "🎮 Jogo", "imagem_url": "https://cdn.akamai.steamstatic.com/steam/apps/1245620/header.jpg"},
    {"id": 6, "nome": "God of War Ragnarok", "preco_original": 69.90, "preco_oferta": 32.90, "descricao": "Continuação épica de Kratos.", "categorias": ["Ação", "Aventura", "Destaques"], "oferta": True, "plataforma": "PC", "tipo": "🎮 Jogo", "imagem_url": "https://cdn.akamai.steamstatic.com/steam/apps/2322010/header.jpg"},
    ...
    if state == "REGISTERING":
        if "nome" not in data:
            ...
            if redirect == "checkout":
                # Simula um callback para checkout
                class FakeCallback:
