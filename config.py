...
# ── Link fictício de download (será substituído pelo real) ──
DOWNLOAD_BASE_URL = os.getenv("DOWNLOAD_BASE_URL", "https://nexusdigitalshop.com.br/downloads/")

# ── Tempo de expiração do link de download (em horas) ──
...
PIX_TIPO = os.getenv("PIX_TIPO", "Celular")  # CPF, Email, Celular ou Aleatória
